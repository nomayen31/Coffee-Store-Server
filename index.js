...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.SECRET_KEY}@cluster0.07lgbsy.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        app.put('/coffee/:id', async (req, res) => {
            ...
            const coffee = {
                $set:{
                    name: updatedCoffee.name, quantity: updatedCoffee.quantity, supplier: updatedCoffee.supplier, taste: updatedCoffee.taste, details: updatedCoffee.details, category: updatedCoffee.category, photo:updatedCoffee.photo
                }
            }
